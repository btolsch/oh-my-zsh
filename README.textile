...
My fork of oh-my-zsh to make a small git prompt improvement. The improvement is based on older script modifications by Steve Losh (http://stevelosh.com/blog/2010/02/my-extravagant-zsh-prompt/).
...
h3. The manual (only) way

1. Clone the repository

  @git clone git://github.com/btolsch/oh-my-zsh.git ~/.oh-my-zsh@
